...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_plugins_SOURCE_PREFIX /home/vas0006/workspaces/gazebo_robots_ws/src/gazebo_ros_pkgs/gazebo_plugins)
  set(gazebo_plugins_DEVEL_PREFIX /home/vas0006/workspaces/gazebo_robots_ws/devel)
  ...
  set(gazebo_plugins_INSTALL_PREFIX /home/vas0006/workspaces/gazebo_robots_ws/install)
...
if(NOT "/home/vas0006/workspaces/gazebo_robots_ws/devel/include;/home/vas0006/workspaces/gazebo_robots_ws/src/gazebo_ros_pkgs/gazebo_plugins/include " STREQUAL " ")
  set(gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/vas0006/workspaces/gazebo_robots_ws/devel/include;/home/vas0006/workspaces/gazebo_robots_ws/src/gazebo_ros_pkgs/gazebo_plugins/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vas0006/workspaces/gazebo_robots_ws/src/gazebo_ros_pkgs/gazebo_plugins/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(gazebo_plugins_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "vision_reconfigure;gazebo_ros_utils;gazebo_ros_camera_utils;gazebo_ros_camera;gazebo_ros_multicamera;gazebo_ros_depth_camera;gazebo_ros_openni_kinect;gazebo_ros_gpu_laser;gazebo_ros_laser;gazebo_ros_block_laser;gazebo_ros_p3d;gazebo_ros_imu;gazebo_ros_f3d;gazebo_ros_ft_sensor;gazebo_ros_bumper;gazebo_ros_template;gazebo_ros_projector;gazebo_ros_prosilica;gazebo_ros_force;gazebo_ros_joint_trajectory;gazebo_ros_joint_state_publisher;gazebo_ros_joint_pose_trajectory;gazebo_ros_diff_drive;gazebo_ros_tricycle_drive;gazebo_ros_skid_steer_drive;gazebo_ros_video;gazebo_ros_planar_move;gazebo_ros_vacuum_gripper;gazebo_ros_ackermann_drive;gazebo_ros_test_control")
...
set(depends "message_generation;gazebo_msgs;roscpp;rospy;nodelet;angles;std_srvs;geometry_msgs;sensor_msgs;nav_msgs;urdf;tf;tf2_ros;dynamic_reconfigure;rosgraph_msgs;trajectory_msgs;image_transport;rosconsole;camera_info_manager;std_msgs;ackermann_msgs")
