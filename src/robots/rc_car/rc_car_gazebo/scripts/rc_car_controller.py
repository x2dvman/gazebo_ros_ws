...
class _AckermannCtrlr(object):
    ...
    def __init__(self):
        ...
        print 'Before creating publishers'
    ...
    def _get_front_wheel_params(self, side):
        ...
        return steer_link_name, steer_ctrlr_name
